...
namespace Chatbot.ServiceDependencies
{
    public class ChatDependencies : IChatDependencies
    {
        ...
        public async Task<string> Chat(ChatDto chat)
        {
            ...
            AssistantService assistant = CreateAssistant();
            dynamic result = assistant.Message(workspace, input: input, context: chat.Context ?? null, alternateIntents: true);
        ...
        private AssistantService CreateAssistant()
        {
            ...
            IamAuthenticator authenticator = new(apikey: apiKey);
